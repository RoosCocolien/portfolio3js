...
(function(ACTION2) {
  ...
  ACTION2[ACTION2["ROTATE"] = 1] = "ROTATE";
  ACTION2[ACTION2["TRUCK"] = 2] = "TRUCK";
  ACTION2[ACTION2["OFFSET"] = 3] = "OFFSET";
  ACTION2[ACTION2["DOLLY"] = 4] = "DOLLY";
  ACTION2[ACTION2["ZOOM"] = 5] = "ZOOM";
  ACTION2[ACTION2["TOUCH_ROTATE"] = 6] = "TOUCH_ROTATE";
  ACTION2[ACTION2["TOUCH_TRUCK"] = 7] = "TOUCH_TRUCK";
  ACTION2[ACTION2["TOUCH_OFFSET"] = 8] = "TOUCH_OFFSET";
  ACTION2[ACTION2["TOUCH_DOLLY"] = 9] = "TOUCH_DOLLY";
  ACTION2[ACTION2["TOUCH_ZOOM"] = 10] = "TOUCH_ZOOM";
  ACTION2[ACTION2["TOUCH_DOLLY_TRUCK"] = 11] = "TOUCH_DOLLY_TRUCK";
  ACTION2[ACTION2["TOUCH_DOLLY_OFFSET"] = 12] = "TOUCH_DOLLY_OFFSET";
  ACTION2[ACTION2["TOUCH_ZOOM_TRUCK"] = 13] = "TOUCH_ZOOM_TRUCK";
  ACTION2[ACTION2["TOUCH_ZOOM_OFFSET"] = 14] = "TOUCH_ZOOM_OFFSET";
})(ACTION || (ACTION = {}));
...
var EventDispatcher = function() {
  ...
  EventDispatcher2.prototype.removeEventListener = function(type, listener) {
    var listeners = this._listeners;
  ...
  EventDispatcher2.prototype.removeAllEventListeners = function(type) {
    if (!type) {
      this._listeners = {};
      return;
    }
...
var CameraControls = function(_super) {
  __extends(CameraControls2, _super);
  function CameraControls2(camera, domElement) {
    ...
    _this._truckInternal = function(deltaX, deltaY, dragToOffset) {
      if (isPerspectiveCamera(_this._camera)) {
        ...
        var camera2 = _this._camera;
        var truckX = deltaX * (camera2.right - camera2.left) / camera2.zoom / _this._elementRect.z;
        var pedestalY = deltaY * (camera2.top - camera2.bottom) / camera2.zoom / _this._elementRect.w;
        dragToOffset ? _this.setFocalOffset(_this._focalOffsetEnd.x + truckX, _this._focalOffsetEnd.y + pedestalY, _this._focalOffsetEnd.z, true) : _this.truck(truckX, pedestalY, true);
      }
    };
    ...
    if (_this._domElement) {
      ...
      var onMouseWheel_1 = function(event) {
        ...
        if (_this.dollyToCursor || _this.mouseButtons.wheel === ACTION.ROTATE || _this.mouseButtons.wheel === ACTION.TRUCK) {
          ...
          if (lastScrollTimeStamp_1 - now < 1e3)
      ...
      var dragging_1 = function(event) {
        ...
        switch (_this._state) {
          ...
          case ACTION.ZOOM: {
            ...
            _this._state === ACTION.DOLLY ? _this._dollyInternal(deltaY * TOUCH_DOLLY_FACTOR, dollyX, dollyY) : _this._zoomInternal(deltaY * TOUCH_DOLLY_FACTOR, dollyX, dollyY);
            break;
          }
          ...
          case ACTION.TOUCH_ZOOM_OFFSET: {
            ...
            _this._state === ACTION.TOUCH_DOLLY || _this._state === ACTION.TOUCH_DOLLY_TRUCK ? _this._dollyInternal(dollyDelta * TOUCH_DOLLY_FACTOR, dollyX, dollyY) : _this._zoomInternal(dollyDelta * TOUCH_DOLLY_FACTOR, dollyX, dollyY);
            if (_this._state === ACTION.TOUCH_DOLLY_TRUCK || _this._state === ACTION.TOUCH_ZOOM_TRUCK) {
              _this._truckInternal(deltaX, deltaY, false);
            } else if (_this._state === ACTION.TOUCH_DOLLY_OFFSET || _this._state === ACTION.TOUCH_ZOOM_OFFSET) {
  ...
  CameraControls2.install = function(libs) {
    THREE = libs.THREE;
  ...
  Object.defineProperty(CameraControls2, "ACTION", {
    get: function() {
  ...
  Object.defineProperty(CameraControls2.prototype, "enabled", {
    get: function() {
  ...
  Object.defineProperty(CameraControls2.prototype, "currentAction", {
    get: function() {
      return this._state;
    },
    enumerable: false,
  ...
  Object.defineProperty(CameraControls2.prototype, "distance", {
    get: function() {
  ...
  Object.defineProperty(CameraControls2.prototype, "azimuthAngle", {
    get: function() {
  ...
  Object.defineProperty(CameraControls2.prototype, "polarAngle", {
    get: function() {
  ...
  Object.defineProperty(CameraControls2.prototype, "boundaryEnclosesCamera", {
    get: function() {
  ...
  CameraControls2.prototype.addEventListener = function(type, listener) {
    _super.prototype.addEventListener.call(this, type, listener);
  };
  CameraControls2.prototype.removeEventListener = function(type, listener) {
    _super.prototype.removeEventListener.call(this, type, listener);
  };
  CameraControls2.prototype.rotate = function(azimuthAngle, polarAngle, enableTransition) {
  ...
  CameraControls2.prototype.rotateTo = function(azimuthAngle, polarAngle, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.dolly = function(distance, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
    this.dollyTo(this._sphericalEnd.radius - distance, enableTransition);
  };
  CameraControls2.prototype.dollyTo = function(distance, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.zoom = function(zoomStep, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
    this.zoomTo(this._zoomEnd + zoomStep, enableTransition);
  };
  CameraControls2.prototype.zoomTo = function(zoom, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.pan = function(x, y, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.truck = function(x, y, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.forward = function(distance, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.moveTo = function(x, y, z, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.fitToBox = function(box3OrObject, enableTransition, _a) {
  ...
  CameraControls2.prototype.fitTo = function(box3OrObject, enableTransition, fitToOptions) {
    if (fitToOptions === void 0) {
      fitToOptions = {};
    }
    console.warn("camera-controls: fitTo() has been renamed to fitToBox()");
    this.fitToBox(box3OrObject, enableTransition, fitToOptions);
  };
  CameraControls2.prototype.fitToSphere = function(sphereOrMesh, enableTransition) {
  ...
  CameraControls2.prototype.setLookAt = function(positionX, positionY, positionZ, targetX, targetY, targetZ, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.lerpLookAt = function(positionAX, positionAY, positionAZ, targetAX, targetAY, targetAZ, positionBX, positionBY, positionBZ, targetBX, targetBY, targetBZ, t, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.setPosition = function(positionX, positionY, positionZ, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
    this.setLookAt(positionX, positionY, positionZ, this._targetEnd.x, this._targetEnd.y, this._targetEnd.z, enableTransition);
  };
  CameraControls2.prototype.setTarget = function(targetX, targetY, targetZ, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.setFocalOffset = function(x, y, z, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.setBoundary = function(box3) {
    if (!box3) {
  ...
  CameraControls2.prototype.setViewport = function(viewportOrX, y, width, height) {
    if (viewportOrX === null) {
      this._viewport = null;
      return;
    }
  ...
  CameraControls2.prototype.getDistanceToFitBox = function(width, height, depth) {
  ...
  CameraControls2.prototype.getDistanceToFit = function(width, height, depth) {
  ...
  CameraControls2.prototype.getDistanceToFitSphere = function(radius) {
  ...
  CameraControls2.prototype.getTarget = function(out) {
    var _out = !!out && out.isVector3 ? out : new THREE.Vector3();
    return _out.copy(this._targetEnd);
  };
  CameraControls2.prototype.getPosition = function(out) {
    var _out = !!out && out.isVector3 ? out : new THREE.Vector3();
    return _out.setFromSpherical(this._sphericalEnd).applyQuaternion(this._yAxisUpSpaceInverse).add(this._targetEnd);
  };
  CameraControls2.prototype.getFocalOffset = function(out) {
    var _out = !!out && out.isVector3 ? out : new THREE.Vector3();
    return _out.copy(this._focalOffsetEnd);
  };
  CameraControls2.prototype.normalizeRotations = function() {
    this._sphericalEnd.theta = this._sphericalEnd.theta % PI_2;
    if (this._sphericalEnd.theta < 0)
      this._sphericalEnd.theta += PI_2;
    this._spherical.theta += PI_2 * Math.round((this._sphericalEnd.theta - this._spherical.theta) / PI_2);
  };
  CameraControls2.prototype.reset = function(enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.saveState = function() {
    this._target0.copy(this._target);
    this._position0.copy(this._camera.position);
    this._zoom0 = this._zoom;
  };
  CameraControls2.prototype.updateCameraUp = function() {
    this._yAxisUpSpace.setFromUnitVectors(this._camera.up, _AXIS_Y);
    quatInvertCompat(this._yAxisUpSpaceInverse.copy(this._yAxisUpSpace));
  };
  CameraControls2.prototype.update = function(delta) {
    var dampingFactor = this._state === ACTION.NONE ? this.dampingFactor : this.draggingDampingFactor;
    var lerpRatio = 1 - Math.exp(-dampingFactor * delta * FPS_60);
  ...
  CameraControls2.prototype.toJSON = function() {
  ...
  CameraControls2.prototype.fromJSON = function(json, enableTransition) {
    if (enableTransition === void 0) {
      enableTransition = false;
    }
  ...
  CameraControls2.prototype.dispose = function() {
    this._removeAllEventListeners();
  };
  CameraControls2.prototype._encloseToBoundary = function(position, offset, friction) {
    ...
    if (deltaClampedTargetLength2 === 0) {
      ...
      var offsetFactor = 1 + friction * deltaClampedTargetLength2 / offset.dot(deltaClampedTarget);
      return position.add(_v3B.copy(offset).multiplyScalar(offsetFactor)).add(deltaClampedTarget.multiplyScalar(1 - friction));
    }
  };
  CameraControls2.prototype._updateNearPlaneCorners = function() {
    if (isPerspectiveCamera(this._camera)) {
      var camera = this._camera;
  ...
  CameraControls2.prototype._collisionTest = function() {
  ...
  CameraControls2.prototype._getClientRect = function(target) {
  ...
  CameraControls2.prototype._removeAllEventListeners = function() {
  };
  return CameraControls2;
}(EventDispatcher);
...
var camera_controls_module_default = CameraControls;

// dep:camera-controls
var camera_controls_default = camera_controls_module_default;
export {
  camera_controls_default as default
};
/*!
 * camera-controls
